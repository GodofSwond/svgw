...
public class FlowLayout extends ViewGroup {
    ...
    private static final int DEFAULT_HORIZONTAL_SPACING = CommonUtils.dip2px(MyApplication.getInstance(), 10);
    private static final int DEFAULT_VERTICAL_SPACING = CommonUtils.dip2px(MyApplication.getInstance(), 10);
