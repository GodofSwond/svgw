...
import com.svgouwu.client.activity.GoodsDetailsActivity;
import com.svgouwu.client.adapter.ItemRecommendAdapter;
import com.svgouwu.client.adapter.NetworkImageHolderView;
import com.svgouwu.client.bean.RecommendGoodsBean;
import com.svgouwu.client.view.SlideDetailsLayout;
...
public class GoodsInfoFragment extends Fragment implements View.OnClickListener, SlideDetailsLayout.OnSlideDetailsListener {
    ...
    private void scrollCursor() {
        ...
        for (int i = 0; i < tabTextList.size(); i++) {
            tabTextList.get(i).setTextColor(i == nowIndex ? getResources().getColor(R.color.color_money) : getResources().getColor(R.color.color_text_title));
        }
    }
