...
//                .displayer(new FadeInBitmapDisplayer(200))//图片显示时间
//                .build();
//        return options;
//    }
    /**
     * ImageLoader配置 一般性的
     */
//    public static DisplayImageOptions getDisplayImageOptions(int loadImg) {
//        DisplayImageOptions options = new DisplayImageOptions.Builder()
//                .resetViewBeforeLoading(true)
//                .cacheOnDisk(true)
//                .cacheInMemory(true)
...
//                .imageScaleType(ImageScaleType.EXACTLY)
//                .bitmapConfig(Bitmap.Config.RGB_565)
//                .showImageOnLoading(R.drawable.icon_goods_default)
//                .considerExifParams(true)
