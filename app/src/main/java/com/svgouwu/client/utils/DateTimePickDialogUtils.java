...
timePicker.setOnTimeChangedListener(this);*/
        ...
        ad = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton(activity.getString(R.string.dialog_date_set), null)
                .setNegativeButton(activity.getString(R.string.dialog_date_cancle), new DialogInterface.OnClickListener() {
