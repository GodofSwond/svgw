package com.svgouwu.client.jpush;
...
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_ADD;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_CHECK;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_CLEAN;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_DELETE;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_GET;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.ACTION_SET;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.TagAliasBean;
import static com.svgouwu.client.jpush.TagAliasOperatorHelper.sequence;
...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
    ...
    private void setStyleCustom() {
        CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this, R.layout.jpush_notitfication_layout, R.id.icon, R.id.title, R.id.text);
        builder.layoutIconDrawable = R.drawable.ic_logo;
